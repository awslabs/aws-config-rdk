...
stack_status_ap_east = cfn_client_ap_east.describe_stacks(StackName="WMFAENABLEDRULE")
...
stack_status_us_west = cfn_client_us_west.describe_stacks(StackName="WMFAENABLEDRULE")
