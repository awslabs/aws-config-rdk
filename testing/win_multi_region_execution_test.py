...
stack_status_ap_east = cfn_client_ap_east.describe_stacks(StackName="W_MFAENABLEDRULE")
...
stack_status_us_west = cfn_client_us_west.describe_stacks(StackName="W_MFAENABLEDRULE")
